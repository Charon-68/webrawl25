...
import { Award, Calendar, HeartHandshake, ShieldCheck, Users } from 'lucide-react'
...
export default function AboutUsGrid() {
  return (
    <section id="about" className="py-20 bg-yellow-100/70 dark:bg-yellow-600/30">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-6 lg:grid-cols-12 gap-4 md:gap-6 auto-rows-[minmax(180px,1fr)]">
          ...
          <ScrollReveal className={`${cardBase} sm:col-span-3 lg:col-span-4 p-6 min-h-[220px]`}>
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                ...
                <div
                  key={item.title}
                  className="rounded-xl bg-amber-50/70 dark:bg-amber-200/10 border border-amber-100/60 dark:border-amber-300/20 p-3"
                >
          ...
          <ScrollReveal className={`${cardBase} sm:col-span-3 lg:col-span-4 p-6 min-h-[220px]`}>
            ...
            <div className="grid grid-cols-2 gap-3 h-full">
              {[aboutus2, aboutus3, aboutus4].map((img, idx) => (
              ...
              <div className="flex items-center justify-center rounded-xl bg-gradient-to-br from-primary/15 to-amber-200/40 dark:from-primary/20 dark:to-gray-800 border border-amber-100/60 dark:border-amber-300/30">
                <div className="text-center px-3">
                  <p className="text-sm uppercase tracking-wide text-primary-dark/80 dark:text-primary/80">Gallery</p>
                  <p className="text-lg font-semibold text-gray-900 dark:text-white">Live performances, debates, all-night builds.</p>
                </div>
              </div>
            </div>
          </ScrollReveal>
